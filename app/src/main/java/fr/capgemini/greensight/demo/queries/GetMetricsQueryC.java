...
public class GetMetricsQueryC
{
	...
	public GetMetricsQueryC(ApplicationConfiguration applicationConfiguration)
	{
	...
	public GetMetricsQueryResult run() throws Exception
	{
		...
		try
		{
			...
			String selectQuery = "SELECT * FROM measures WHERE datetime BETWEEN ? AND ?";
